        ...
        <div class="container">
            <div class="pull-left auto-width-left">
                <ul class="top-menu menu-beta l-inline">
                    <li><a href=""><i class="fa fa-home"></i> Nghĩa Hương-Quốc Oai-Hà Nội</a></li>
                    <li><a href=""><i class="fa fa-phone"></i> 0981778556</a></li>
                </ul>
            </div>
                ...
                <div class="cart">
                    ...
                    <div class="beta-dropdown cart-body">
                        ...
                        <div class="cart-caption">
                            <div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">$34.55</span>
                            </div>
                            <div class="clearfix"></div>
        ...
        <nav class="main-menu">
            <ul class="l-inline ov">
                ...
                <li><a href="#">Loại Sản Phẩm</a>
                    <ul class="sub-menu">
                        @foreach($sanphamtype as $sp)
                            <li><a href="{{url('gettypesanpham/'.$sp->id)}}">{{$sp->name}}</a></li>
                        @endforeach
                    </ul>
                </li>
                <li><a href="{{url('getgioithieu')}}">Giới thiệu</a></li>
                <li><a href="{{url('getlienhe')}}">Liên hệ</a></li>
            </ul>
            <div class="clearfix"></div>
        </nav>
    </div> <!-- .container -->
